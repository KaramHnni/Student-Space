...
Route::get('/sign-up/teacher/info','Auth\SignUpController@showTeacherInfo')->name('site.sign-up.teacher.info');
Route::post('/sign-up/teacher/info','Auth\SignUpController@registerTeacherInfo');
