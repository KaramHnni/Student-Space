    ...
    <div>
        ...
        <form>
            <div class="mb-8 mt-4">
                ...
                <input id="Subject"  type="text" class="focus:border ml-4 focus:border-solid focus:border-blue-light inline-block rounded  px-4 py-2 border border-solid">
            </div>
            <div class="mb-8">
                <label class="font-bold " for="justification">Justification</label>
            <textarea id="justification" class=" mt-4 focus:border px-2 py-2 lg:ml-4 focus:border-solid focus:border-blue-light w-full h-64 rounded   border border-solid "placeholder="write your justification here ..."></textarea>
            </div>
            <div class="mb-8">
                    <label class="font-bold " for="upload">Justification File</label>
                <input type="file" id="upload" class="ml-4" >
            </div>
            <div class="text-center">
            <a  class=" inline-block px-4 py-2  bg-blue shadow rounded text-white">Submit</a>
            </div>
        </form>
